...
class MarksControllerTest < ActionController::TestCase
  ...
  test "destroy json" do
    assert_difference('Mark.count', -1) do
      delete :destroy, id: @mark, format: :json
    end

    assert_response :success
  end

  test "create new json" do
    # vytvori novou znamku
    ...
    assert_difference('Mark.count', 1) do
      post :create, value: 3, recipe: @recipe.id, format: :json
    end
    assert_response :success
  end

  test "create existing json" do
    # pouze updatuje
    ...
    assert_difference('Mark.count', 0) do
      post :create, value: 1, recipe: marks(:one).recipe_id, format: :json
    end
